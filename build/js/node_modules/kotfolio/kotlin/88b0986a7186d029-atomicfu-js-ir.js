(function (root, factory) {
  ...
  protoOf(AtomicRef).sf = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).tf = function () {
  ...
  protoOf(AtomicBoolean).uf = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).tf = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).vf = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).tf = function () {
    return this.kotlinx$atomicfu$value;
  };

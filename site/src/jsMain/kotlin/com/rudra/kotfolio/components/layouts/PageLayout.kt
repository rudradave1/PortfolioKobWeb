package com.rudra.kotfolio.components.layouts
...
import com.rudra.kotfolio.components.sections.Footer
import com.rudra.kotfolio.components.sections.NavHeader
import com.rudra.kotfolio.components.widgets.AppearanceAwareImage
import com.rudra.kotfolio.components.widgets.BackToTopButton
import com.rudra.kotfolio.utils.Res
import com.rudra.kotfolio.toSitePalette
...
fun PageLayout(title: String, content: @Composable ColumnScope.() -> Unit) {
    ...
    LaunchedEffect(title) {
        document.title = "Rudra Dave - $title"
    }

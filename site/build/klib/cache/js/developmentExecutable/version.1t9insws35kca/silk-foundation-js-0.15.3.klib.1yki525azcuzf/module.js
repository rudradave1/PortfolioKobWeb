(function (root, factory) {
  ...
  var throwKotlinNothingValueException = kotlin_kotlin.$_$.we;
  ...
  protoOf(ComponentStyle_0).addVariant_yvcl2q_k$ = function (name, extraModifiers, init) {
  ...
  protoOf(ComponentStyle_0).addVariant$composable_ersrxb_k$ = function (name, extraModifiers, init) {
